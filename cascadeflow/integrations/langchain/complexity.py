...
class ComplexityDetector:
    ...
    MATHEMATICS_TERMS = {
        ...
        # Topology
        'hausdorff space', 'topological space', 'homeomorphism', 'homotopy',
        'fundamental group', 'manifold', 'compactness', 'connectedness',
        'metric space', 'banach space', 'hilbert space',
        # Analysis
    ...
    CS_TERMS = {
        ...
        'regularization', 'cross-validation', 'reinforcement learning',
        'q-learning',
        # Quantum Computing
        'quantum computing', 'quantum algorithm', 'quantum supremacy',
        'qubit', 'quantum gate', 'quantum circuit',
    }
    ...
    def detect(self, query: str, return_metadata: bool = False) -> ComplexityResult:
        ...
        tech_boost = self._calculate_technical_boost(
            len(tech_terms),
            0,  # math notation length (simplified)
            domain_scores
        )
