...
Most AI optimization tools sit outside the agent — at the HTTP boundary, in a proxy, or in a dashboard after the fact. cascadeflow sits **inside** the agent loop, where decisions actually happen.

This is the difference between watching outcomes and controlling them.
